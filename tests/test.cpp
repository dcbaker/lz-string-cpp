...
TEST(compressToBase64, CompareToGold_short) {
    ...
    lzstring::string gold =
        _U(R"(NobwRAdmBcYA4GcCMA6AhgYwC4EsBuApmADRgCOMSpWlALAOy0DMArAGxK1csul4wAmJAF8AukA=)");
...
TEST(compressToBase64, CompareToGold_UTF8) {
    ...
    lzstring::string gold =
        _U(R"(KoFQYgtAHABAtgSwCZIDYFMZIPYBcYDkA7QQHQwBKAhgHY5wy7oAe+gJICA7wAAqAyoEA===)");
...
TEST(CompareToJavaScript, compressToBase64) {
    ...
    EXPECT_EQ(
        compressed,
        _U(R"(NobwRAZg9lYFwBYBMBfANOADgS3gZgDoBGBdMAGygDsBzAAgBMBDAZwAs6WBPAWwCMo5eGEAoBGAC6QA)"));
}

TEST(CompareToJavaScript, decompressFromBase64) {
    lzstring::string fromJS =
        _U(R"(NobwRAZg9lYFwBYBMBfANOADgS3gZgDoBGBdMAGygDsBzAAgBMBDAZwAs6WBPAWwCMo5eGEAoBGAC6QA)");
